...
| :--- | :---: | :---: | :--- |
| **Rod of the Pact Keeper +1** (Tasha's) | Sí | ⚔️ **Sí** | **Priorizar 1:** $+1$ a la CD de tus conjuros de Brujo y tiradas de ataque. Te permite recuperar 1 ranura de Warlock una vez al día como acción. |
| **Hand Crossbow +1** | No | — | **Priorizar 2:** $+1$ a tiradas de ataque y daño físico básico. |
...
| Objeto | Requiere Sintonización | ¿Sintonizado? | Prioridad / Notas |
| :--- | :---: | :---: | :--- |
| **Rod of the Pact Keeper +2** | Sí | ⚔️ **Sí** | **Priorizar 1:** Incrementa tu CD de Warlock y precisión de ataques mágicos a $+2$. |
| **Cloak of Protection** | Sí | ⚔️ **Sí** | **Priorizar 2:** $+1$ a la CA y a todas tus salvaciones (esencial para mantener la concentración en *Shadow of Moil*). |
| **Hand Crossbow +2** | No | — | **Priorizar 3:** Reemplaza la ballesta $+1$. Aumenta tu acierto y daño plano. |
| **Ring of Spell Storing** | Sí | No | Prioridad Media: Permite delegar la concentración de *Darkness* a tu familiar. |
...
| **Ring of Protection** | Sí | ⚔️ **Sí** | **Priorizar 2:** $+1$ a la CA y salvaciones (apila con la Capa de protección para un $+2$ total). |
| **Amulet of Health** | Sí | No | **Priorizar 3:** Fija tu Constitución a **19**, aumentando radicalmente tus HP máximos en primera línea. |
| **Armor +2 (Half-Plate)** | No | — | Prioridad Alta: CA pasiva sube a 19 (24 con el conjuro *Shield*). |
