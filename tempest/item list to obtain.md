...
| :--- | :---: | :---: | :--- |
| **Amulet of the Devout +1 + CMT** | Sí | ⚔️ **Sí** | **Priorizar 1** |
| **Sentinel Shield** | Sí | ⚔️ **Sí** | **Priorizar 2** |
| **Splint Mail \|\| Plate Armor** | No | — | Prioridad 3 |
| **Bag of Holding** | No | — | Prioridad Media |
| **Boots of Striding and Springing** | Sí | No | Prioridad Baja |
...
| Objeto | Requiere Sintonización | ¿Sintonizado? | Prioridad / Notas |
| :--- | :---: | :---: | :--- |
| **Amulet of Health** | Sí | ⚔️ **Sí** | **Priorizar 1** |
| **Amulet of the Devout +2 + CMT** | Sí | ⚔️ **Sí** | **Priorizar 2** |
| **Weapon of Warning** | Sí | ⚔️ **Sí** | **Priorizar 3** |
| **Armor +1 (Plate) y Shield +1** | No | — | Prioridad Alta |
| **Ring of Free Action** | Sí | No | Prioridad Media |
| **Cloak of Protection** | Sí | No | Prioridad Baja |
| **Belt of Hill Giant Strength** | Sí | No | *Me hace gracia pero no hace falta si uso el true strike nuevo* |
| **Staff of Healing** | Sí | No | *Esto realmente no hace falta, pero por si acaso* |
...
| Objeto | Requiere Sintonización | ¿Sintonizado? | Prioridad / Notas |
| :--- | :---: | :---: | :--- |
| **Staff of Power** | Sí | ⚔️ **Sí** | **Priorizar 1** |
| **Rod of Absorption** | Sí | ⚔️ **Sí** | **Priorizar 2** |
| **Amulet of the Devout +3 + CMT** | Sí | ⚔️ **Sí** | **Priorizar 3** |
| **Armor +2 (Plate) y Shield +2** | No | — | Prioridad Alta |
| **Spellguard Shield** | Sí | No | *Este es redundante, pero para reserva está muy bien* |

---

## 🟠 Tier 4 (Niveles 17-20) — Legendarios

| Objeto | Requiere Sintonización | ¿Sintonizado? | Prioridad / Notas |
| :--- | :---: | :---: | :--- |
| **Staff of the Magi** | Sí | ⚔️ **Sí** | **Priorizar 1** |
| **Ioun Stone of Mastery** | Sí | ⚔️ **Sí** | **Priorizar 2** |
| **Armor +3 (Plate) y Shield +3** | No | — | **Prioridad 3** |
| **Robe of the Archmage** | Sí | No | *Depende de si me dejas ponerla por encima de la armadura es 2 o nula* |
