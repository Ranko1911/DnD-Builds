# Guía de Personaje — Techpriest (Edición 2024 / 5.5e)
...
Species: Enano de las Colinas (2024) [Dote de Origen: Artesano]
...
Combat Role: Ultra Tank / Support Crafter / AoE Controller
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Warhammer (Push) & Shield (Sap):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Guardian Armor + Blessing of the Forge + Spirit Guardians 2024

🧮 Mathematical Engine 2024:

$$\text{CA Pasiva Total} = 18 (\text{Plate}) + 2 (\text{Shield}) + 1 (\text{Forge}) + 2 (\text{Infusion}) = \mathbf{23 \text{ CA}} + 3\text{d}8 \text{ Área}$$
