# 🌟 Lista de Conjuros Optimizada — Priest of the Wilds

Esta lista detalla la selección de conjuros sugerida para el build **Priest of the Wilds**, optimizada bajo las reglas de la mesa.

> **Nota Mesa:** El arco largo consagrado actúa como foco unificado para canalizar toda la magia de explorador y de clérigo de forma continua.
...
### Cleric
1.  **Guidance 🔵 [Indispensable]:** +1d4 a chequeos de habilidad fuera de combate.
2.  **Spare the Dying 🟢 [Excelente]:** Estabilizar aliados caídos a 0 PG sin chequeo médico.
3.  **Resistance 🟡 [Situacional]:** +1d4 a tiradas de salvación de un aliado voluntario.

---

## 🎒 Conjuros Preparados / Conocidos por Niveles

*Preparas SAB (+3) + Cleric Level (8) = 11 conjuros de Clérigo. Conoces 7 conjuros de la lista de Ranger.*
