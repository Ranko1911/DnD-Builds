...
Combat Role: Frontline Thorns Tank / Heavy Striker
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Glaive (Graze) & Halberd (Cleave):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Thorns from Hell 2024 (Armor of Agathys + Rage 2024 + Dark One's Blessing)

🧮 Mathematical Engine 2024:

$$\text{DPR Sostenido} = 1\text{d}10 + 1\text{d}6 + 19 (\text{Zealot}) + 1\text{d}10 + 16 + 1\text{d}4 + 10 (\text{PAM}) = \mathbf{65.0 \text{ daño/turno}} + 25 \text{ frío/golpe}$$
