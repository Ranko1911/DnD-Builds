# Guía de Personaje — Furry Fury (Edición 2024 / 5.5e)
...
Species: Tabaxi (o Leonin 2024) [Dote de Origen: Músico]
...
Combat Role: Hybrid Gish Blaster / Party Buffer
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Scimitar (Nick) & Light Crossbow (Slow):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Extra Attack 2024 (Sustituir 1 ataque por Cantrip) + Eldritch Blast

🧮 Mathematical Engine 2024:

$$\text{DPR Valor 2024} = 1\text{d}6 + 5 + 4 \times (1\text{d}10 + 5 (\text{Agonizing})) = \mathbf{50.5 \text{ daño Híbrido}}$$
