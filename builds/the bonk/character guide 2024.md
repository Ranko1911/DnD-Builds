...
Species: Minotauro (o Orco 2024) [Dote de Origen: Tavern Brawler 2024]
...
Combat Role: Stun Striker / Undying Martial Tank
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Unarmed Strike (Grapple / Push 2024):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Beast Claws + Flurry of Blows 2024 + Touch of the Long Death

🧮 Mathematical Engine 2024:

$$\text{DPR 5 Ataques por Turno} = 3 \times (1\text{d}6 + 3 + 2) + 2 \times (1\text{d}10 + 3 + 2) = \mathbf{42.5 \text{ daño física/tóxica}}$$
