# Guía de Personaje — Warrior of Flame (Edición 2024 / 5.5e)
...
Class Split: Sorcerer (Draconic - Red) 14 / Paladin (Devotion) 6

Species: Dragonborn (Fuego 2024) [Dote de Origen: Alerta]
...
Combat Role: Fire Gish Striker / Aura Support Tank
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Greatsword (Graze) & Longsword (Sap):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Aura of Devotion + Elemental Affinity (Fire) + Green-Flame Blade Smites

🧮 Mathematical Engine 2024:

$$\text{DPR Green-Flame Smite} = 2\text{d}6 + 4 + 4 (\text{CHA Fire}) + 3\text{d}8 (\text{GFB}) + 5\text{d}8 (\text{Smite}) = \mathbf{57.0 \text{ daño}}$$
