# 🌟 Lista de Conjuros Optimizada — Warrior of Flame

Esta lista detalla la selección de conjuros sugerida para el build **Warrior of Flame**, optimizada bajo las reglas de la mesa.

> **Nota Mesa:** El escudo grabado sirve como canalizador universal de Hechicero y Paladín, permitiendo lanzar conjuros con las manos ocupadas gracias a la dote *War Caster*.
...
### Sorcerer
1.  **Green-Flame Blade 🔵 [Indispensable - Ofensivo]:** Tu ataque elemental principal. Suma daño de fuego e impacta a un enemigo secundario adyacente. Escalado potenciado por Carisma.
2.  **Fire Bolt 🟢 [Excelente - Ofensivo]:** Ataque a distancia de fuego. Añade el bono de Afinidad Elemental de Dragón Dorado (+5).
3.  **Shocking Grasp 🟢 [Excelente]:** Ataque cuerpo a cuerpo relámpago que evita que el enemigo realice reacciones (útil para escapar sin provocar ataques de oportunidad).

---

## 🎒 Conjuros Preparados / Conocidos por Niveles

*Preparas/Conoces 13 conjuros de Hechicero y preparas 8 conjuros de la lista de Paladín.*
...
1.  **Teleport (Nivel 7) 🟢 [Excelente]:** Transportación instantánea de todo el grupo a largas distancias.
