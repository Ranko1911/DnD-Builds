...
Class Split: Sorcerer (Shadow/Clockwork) 1 / Rogue (Swashbuckler/Arcane Trickster) 19

Species: Mediano Piesligeros (2024) [Dote de Origen: Alerta]
...
Combat Role: Evasive Single-Target Striker / Stealth Operative
...
## 3. The META Combo 2024: Shield Spell Reaction + True Strike 2024 + Sneak Attack 10d6

🧮 Mathematical Engine 2024:

$$\text{DPR Sneak Attack 2024} = 1\text{d}8 + 5 + 10\text{d}6 + 3\text{d}8 (\text{True Strike}) = \mathbf{58.0 \text{ daño con Ventaja Vex}}$$
