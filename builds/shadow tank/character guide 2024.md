# Guía de Personaje — Shadow Tank (Edición 2024 / 5.5e)
...
Combat Role: Universal Resilient Tank / Reflective Counter
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Greatsword (Graze) & Glaive (Graze):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Armor of Agathys Level 9 + Bear Totem Universal Resistance

🧮 Mathematical Engine 2024:

$$\text{EHP Armor of Agathys (Level 9)} = \frac{45 \text{ Temp HP}}{0.5 \text{ (Resistance)}} = \mathbf{90 \text{ EHP}} + 45 \text{ frío/golpe}$$
