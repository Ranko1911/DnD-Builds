# Guía de Personaje — Spymaster (Edición 2024 / 5.5e)
...
Species: Changeling (o Elfo 2024) [Dote de Origen: Alerta]
...
Combat Role: Infiltration Expert / Unmissable Psychic Striker
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Psychic Blades (Nick / Vex):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Psychic Telepathy + Homing Strikes + Invisibility Infusion

🧮 Mathematical Engine 2024:

$$\text{DPR Psychic Blades} = 1\text{d}6 + 5 + 9\text{d}6 (\text{Sneak}) + 1\text{d}4 + 5 = \mathbf{47.5 \text{ daño psíquico plano}}$$
