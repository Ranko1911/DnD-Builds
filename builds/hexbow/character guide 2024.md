# Guía de Personaje — Hexbow (Edición 2024 / 5.5e)
...
Species: Elfo Oscuro (2024) [Dote de Origen: Alerta]
...
Combat Role: Ranged Heavy Striker / Critical Assassin
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Heavy Crossbow (Push) & Longbow (Slow):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Eldritch Smite + Sharpshooter + Hexblade's Curse + Action Surge

🧮 Mathematical Engine 2024:

$$\text{DPR Burst (Turno 1)} = 4 \times (1\text{d}10 + 5 (\text{CHA}) + 6 (\text{Curse})) + 5\text{d}8 (\text{Smite}) = \mathbf{93.5 \text{ daño}}$$
