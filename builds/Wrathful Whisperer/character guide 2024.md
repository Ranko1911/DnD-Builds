# Guía de Personaje — Wrathful Whisperer (Edición 2024 / 5.5e)
...
Species: Humano (2024) [Dote de Origen: Músico + Savage Attacker]
...
Combat Role: Full Caster Gish / Divine Smite Striker
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Rapier (Vex) & Scimitar (Nick):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Blade Flourish + Divine Smite Level 9 + Magical Secrets 2024

🧮 Mathematical Engine 2024:

$$\text{DPR Impacto Crítico Smite} = 2 \times (1\text{d}8 + 5) + 2 \times (1\text{d}10) + 10\text{d}8 (\text{Smite}) = \mathbf{72.0 \text{ daño}}$$
