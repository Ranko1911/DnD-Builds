...
* **Arma Principal:** Battle Axe de acero (Daño: $1d8$ cortante, versátil $1d10$).
* **Armadura:** Sin armadura (Unarmored Defense: $10 + \text{DEX} + \text{CON}$). Escudo de madera (+2 CA).
* **Foco / Reliquias:** Foco druídico (rama de roble tallada con runas ancestrales).
...
* Diamante (valor 300 po, componente para Revivify)
* Poción de curación mayor (1)
* Poción de curación común (2)
* Goodberries (frescas, caducan a las 24h)
* Totem ancestral de madera (objeto simbólico de la tribu)
