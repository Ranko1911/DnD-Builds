# Guía de Personaje — Moon Guardian (Edición 2024 / 5.5e)
...
Combat Role: Taunt Tank / Wildshape Disruptor
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Unarmed (Grapple/Shove) & Bite/Claw:** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Wild Shape Elemental + Ancestral Protectors + Rage 2024

🧮 Mathematical Engine 2024:

$$\text{EHP Elemental Furia} = \frac{126 \text{ HP Bestia}}{0.5 \text{ (Rage)}} = \mathbf{252 \text{ EHP}} + \text{Desventaja en enemigos}$$
