# Guía de Personaje — Fartificer (Edición 2024 / 5.5e)
...
Species: Gnomo (2024) [Dote de Origen: Artesano]
...
Combat Role: Int-Based Heavy Tank / Companion Master
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Warhammer (Push) & Greatsword (Graze):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Battle Ready (INT to Attack) + Steel Defender + Stinking Cloud / Thunderwave

🧮 Mathematical Engine 2024:

$$\text{DPR INT Greatsword} = 3 \times (2\text{d}6 + 5) + 1\text{d}8+2 (\text{Defender}) = \mathbf{42.5 \text{ daño INT}}$$
