# Guía de Personaje — Furious Paradox (Edición 2024 / 5.5e)
...
Combat Role: High AC Evasive Tank / Arcane Striker
...
## 3. The META Combo 2024: Unarmored Defense + Bladesong + Reckless Attack (Sin Furia)

🧮 Mathematical Engine 2024:

$$\text{CA Pasiva Total} = 10 + 5 (\text{DEX}) + 2 (\text{CON}) + 4 (\text{INT Bladesong}) = \mathbf{21 \text{ CA}} + 5 (\text{Shield}) = \mathbf{26 \text{ CA}}$$
