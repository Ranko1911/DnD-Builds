# Guía de Personaje — Sneaky Smasher (Edición 2024 / 5.5e)
...
Species: Goliath (2024) [Dote de Origen: Savage Attacker]
...
Combat Role: Grapple Striker / Advantage Assassin Tank
...
## 3. The META Combo 2024: Strength-Based Sneak Attack + Reckless Advantage + Bear Resistance

🧮 Mathematical Engine 2024:

$$\text{DPR Reckless Sneak} = 1\text{d}8 + 5 (\text{STR}) + 2 (\text{Rage}) + 9\text{d}6 (\text{Sneak}) = \mathbf{43.0 \text{ daño con Ventaja}}$$
