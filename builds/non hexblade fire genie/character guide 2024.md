# Guía de Personaje — Non-Hexblade Fire Genie (Edición 2024 / 5.5e)
...
Species: Goliath (o Tiefling Infernal) [Dote de Origen: Alerta / Savage Attacker]
...
Combat Role: Offensive Fire Striker / Mobile Gish
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Glaive (Graze) & Pike (Push):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Fire Gish (Armor of Agathys + Genie's Wrath + Flying Rage)

🧮 Mathematical Engine 2024:

$$\text{DPR Sostenido} = 1\text{d}10 + 1\text{d}6 + 25 + 1\text{d}10 + 16 = \mathbf{46.0 \text{ daño/turno}} + \text{Vuelo 30 ft sin concentración}$$
