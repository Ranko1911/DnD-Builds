# Guía de Personaje — Beelzebub's Ballista (Edición 2024 / 5.5e)
...
Combat Role: Ranged Heavy Blaster / Healing Support
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Heavy Crossbow (Push):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Radiant Soul + Agonizing Blast + Repelling Blast (Push 40 ft) + Healing Light

🧮 Mathematical Engine 2024:

$$\text{DPR Agonizing Blast + Radiant} = 4 \times (1\text{d}10 + 5) + 5 (\text{Radiant Soul}) = \mathbf{47.0 \text{ daño}} + \text{Empuje 40 ft}$$
