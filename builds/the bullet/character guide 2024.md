# Guía de Personaje — The Bullet (Edición 2024 / 5.5e)
...
Species: Tabaxi (2024) [Dote de Origen: Alerta]
...
Combat Role: Ultra Speed Mobility Striker / Battlefield Courier
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Shortsword (Vex):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Feline Swiftness + Experimental Elixir Swiftness + Bladesong + Step of the Wind

🧮 Mathematical Engine 2024:

$$\text{Velocidad por Turno} = (30 + 10 + 10 + 10) \times 2 (\text{Tabaxi}) \times 2 (\text{Dash}) = \mathbf{240 \text{ pies/turno}}$$
