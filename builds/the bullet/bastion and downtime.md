# 🏰 Bastión y Tiempo Muerto — The Bullet
...
* **Capataz / Administrador (Major Domo):** Swift-Footed Jenkins (un Tabaxi retirado de las carreras).
* **Defensores / Guardias:** 10 guardias ligeros equipados para escaramuzas rápidas.
* **Artesanos / Especialistas:** Un maestro herborista y un escriba (especializado en copiar glifos).

---

## ⏳ Actividades de Tiempo Muerto (Downtime Activities)

### Prioridad 1: Inscripción de Glifos en el Libro de los Glifos

* **Mecánica Base:** Conjuro *Glyph of Warding* (PHB 2014) / Reglas de Escritura de Pergaminos (Xanathar's).
* **Bonificadores Aplicables:** Modificador de INT de $+2$, herramientas de calígrafo y Flash of Genius.
* **Coste por Día/Semana:** $200\text{ po}$ en polvo de diamante por cada glifo inscrito.
* **Objetivo de Optimización:** Inscribir múltiples glifos de *Haste* y *Dissonant Whispers* en las páginas de un libro de cuero tratado, guardado dentro de la *Bag of Holding*, para activarlos en combate de forma instantánea.

### Prioridad 2: Fabricación de Consumibles de Velocidad

* **Mecánica Base:** Fabricación de Objetos Mágicos (Xanathar's Guide to Everything).
* **Bonificadores Aplicables:** Competencia con herramientas de Alquimista y bonificador de nivel 10 Magic Item Adept (reduce a la mitad el coste de creación y el tiempo de objetos comunes/poco comunes).
* **Progreso Actual:** Creación de una *Potion of Speed* en 2 días de trabajo a un coste de $125\text{ po}$.
