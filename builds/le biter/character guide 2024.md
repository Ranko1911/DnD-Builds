# Guía de Personaje — Le Biter (Edición 2024 / 5.5e)
...
Species: Tiflin (2024) [Dote de Origen: Savage Attacker]
...
Combat Role: Dual Wield Master / Counterattack Striker
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Scimitar (Nick) & Shortsword (Vex):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Dual Wielding 2024 + Maneuvers (Riposte) + Blade Flourish

🧮 Mathematical Engine 2024:

$$\text{DPR 4 Ataques Duales} = 4 \times (1\text{d}6 + 5) + 1\text{d}8 (\text{Maneuver}) + 1\text{d}6 (\text{Flourish}) = \mathbf{47.5 \text{ daño}}$$
