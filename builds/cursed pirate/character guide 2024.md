# Guía de Personaje — Cursed Pirate (Edición 2024 / 5.5e)
...
Species: Elfo de los Bosques (2024) [Dote de Origen: Iniciado en la Magia (Mago)]
...
Combat Role: Full Caster Blaster / Support / Constellation Healer
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Scimitar (Nick) & Quarterstaff (Topple):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Starry Form (Archer / Chalice / Dragon) + Free Guiding Bolt

🧮 Mathematical Engine 2024:

$$\text{DPR Forma Estelar (Archer)} = 1\text{d}8 + 5 (\text{WIS}) + \text{Guiding Bolt (4d6)} = \mathbf{23.5 \text{ daño/turno}}$$
