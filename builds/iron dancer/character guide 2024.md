# Guía de Personaje — Iron Dancer (Edición 2024 / 5.5e)
...
Class Split: Wizard (Bladesinger) 18 / Artificer (Battle Smith) 2

Species: Gnomo de las Rocas (2024) [Dote de Origen: Alerta]
...
Combat Role: Unbreakable Concentration Controller / INT Gish
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Rapier (Vex):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Unbreakable Concentration (CON Prof + INT Bladesong + Mind Sharpener)

🧮 Mathematical Engine 2024:

$$\text{Bonificador a Tirada Salvación CON} = +2 (\text{CON}) + 6 (\text{Proficiency}) + 5 (\text{INT Bladesong}) = \mathbf{+13 \text{ a Concentración}}$$
