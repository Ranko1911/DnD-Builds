# Guía de Personaje — Fist of God (Edición 2024 / 5.5e)
...
Species: Humano (2024) [Dote de Origen: Tavern Brawler 2024]
...
Combat Role: Flurry Healer / Radiant Striker
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Unarmed Strike (Grapple/Shove 2024):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Hand of Harm + War Priest Extra Attack + Divine Strike 2024

🧮 Mathematical Engine 2024:

$$\text{DPR 4 Puñetazos + Hand of Harm} = 4 \times (1\text{d}8 + 5) + 1\text{d}8 + 4 (\text{Harm}) = \mathbf{46.5 \text{ daño/turno}}$$
