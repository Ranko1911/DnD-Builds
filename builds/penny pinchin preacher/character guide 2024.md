# Guía de Personaje — Penny Pinchin' Preacher (Edición 2024 / 5.5e)
...
Species: Humano (2024) [Dote de Origen: Iniciado en la Magia (Clérigo)]
...
Combat Role: Support Temp HP Aura / Psychic Assassin
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Psychic Blades (Vex):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Twilight Sanctuary Temp HP + Psychic Blades + Advantage in Darkness

🧮 Mathematical Engine 2024:

$$\text{DPR + Temp HP Aura} = 1\text{d}6 + 5 + 9\text{d}6 + 1\text{d}4 + 5 = \mathbf{47.5 \text{ daño}} + 1\text{d}6+2 \text{ Temp HP/turno al grupo}$$
