# 🌟 Lista de Conjuros Optimizada — Nick Nack Nabber

Esta lista detalla la selección de conjuros sugerida para el build **Nick Nack Nabber**, optimizada bajo las reglas de **D&D 5e 2024 (Artificer Armorer 17 / Rogue Thief 3)**.
...
1. **Guidance** 🟢 *[Soporte]:* Añade 1d4 a pruebas de habilidad de aliados cercanos.
2. **Mending** 🟡 *[Utilidad]:* Esencial para reparar constructos, tu homúnculo o tu armadura.
3. **Fire Bolt** 🟡 *[Daño a Distancia]:* Para cuando no puedas estar en rango cuerpo a cuerpo con tus guanteletes.
4. **Shocking Grasp** 🟡 *[Defensa CaC]:* Evita que el objetivo realice reacciones si logras impactar, permitiendo que un aliado se retire de forma segura.

---

## 🎒 Conjuros Preparados (Ranuras de Conjuro de Niveles 1-5)

*El Artificer prepara conjuros diariamente igual a la mitad de su nivel de Artificer (redondeado hacia abajo) + su modificador de INT (ej. 8 + 5 = 13 conjuros a nivel 20).*
