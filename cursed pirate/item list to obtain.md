...
| :--- | :---: | :---: | :--- |
| **Moon Sickle +1** (Tasha's) | Sí | ⚔️ **Sí** | **Priorizar 1:** $+1$ a ataques y CD de conjuros de Druida. Los conjuros de curación que lances obtienen un $+1d4$ adicional de HP restaurados. Funciona como foco druídico. Sinergiza directamente con tu CD alta de WIS y el rol de controlador/soporte. |
| **Cloak of Elvenkind** | Sí | ⚔️ **Sí** | **Priorizar 2:** Ventaja en Sigilo y desventaja para los ataques contra ti en la oscuridad. Para un pirata que depende del abordaje y la sorpresa, la infiltración es vital. Además, como Sea Elf, el Sigilo bajo el agua es tu segunda naturaleza. |
| **Studded Leather Armor** | No | — | Equipo Base: Armadura ligera CA $12 + 2 (\text{DEX}) = 14$. Compatible con restricciones de Druida (no metálica si tu mesa lo aplica). |
| **Shield +1** | No | — | Prioridad Alta: CA sube a $14 + 2 + 1 = 17$. Escudo de madera o hueso (no metálico). |
| **Bag of Holding** | No | — | Prioridad Media: Para un pirata, almacena botín, componentes, equipo de buceo y cadáveres reanimados. |
...
| Objeto | Requiere Sintonización | ¿Sintonizado? | Prioridad / Notas |
| :--- | :---: | :---: | :--- |
| **Staff of Power** | Sí | ⚔️ **Sí** | **Priorizar 1:** $+2$ a CA, salvaciones y ataques de conjuro. Con acceso a la lista de Mago, los conjuros cargados (Cone of Cold, Globe of Invulnerability, Wall of Force) complementan tu arsenal arcano sin gastar tus propias ranuras. Tu CA con este bastón sube significativamente. |
| **Moon Sickle +3** | Sí | ⚔️ **Sí** | **Priorizar 2:** $+3$ definitivo a CD y ataques de Druida. Tus conjuros arcanos canalizados como druídicos (usando WIS) alcanzan una CD prácticamente imposible de superar. La bonificación de curación ($+1d4$) apila con Heal y Mass Cure Wounds. |
| **Amulet of Health** | Sí | No | Prioridad Alta: Fija CON a 19. Aumenta HP máximos retroactivamente (+60 HP a nivel 20) y mejora salvaciones de concentración. Si usas Dragon Form (mínimo 10 en CON saves), esto te hace virtualmente imposible de interrumpir. |
...
| Objeto | Requiere Sintonización | ¿Sintonizado? | Prioridad / Notas |
| :--- | :---: | :---: | :--- |
| **Orb of Dragonkind (Orbe de Dragón)** | Sí | ⚔️ **Sí** | **Priorizar 1 (Objeto Clave del Personaje):** Permite llamar dragones a 30 millas, detectarlos y controlarlos mentalmente mediante tu CD de WIS 20 (CD 19). Como pirata no muerto con control sobre los mares, dominar dragones marinos y de tormenta es el endgame definitivo. Otorga sentidos aumentados y resistencias. |
| **Robe of the Archmagi** | Sí | ⚔️ **Sí** | **Priorizar 2:** CA base de $15 + 2 (\text{DEX}) = 17$ sin escudo (superior a Studded Leather +2). Ventaja en salvaciones contra conjuros y $+2$ adicional a la CD y ataque de conjuros. Funciona como armadura ligera sin restricciones druídicas. La mejor mejora de CA disponible para un caster sin armadura pesada. |
| **Tome of Understanding** | No | — | Prioridad Alta: $+2$ permanente a WIS (superando 20 hasta 22). Mejora CD de todos los conjuros, Percepción pasiva, y salvaciones de WIS. Tu CD sube a **20** (8 + 6 + 6). |
| **Staff of the Magi** | Sí | No | Prioridad Media: Absorción de conjuros y arsenal masivo. Si ya tienes Staff of Power, esta es la mejora directa pero requiere sintonización (que compite con Orb of Dragonkind y Robe of Archmagi). |
...
**Mecánicas (Diseñadas para la Edición 2014 / 5e):**
