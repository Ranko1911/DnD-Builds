# Guía de Personaje — Eldritch Shadow (Edición 2024 / 5.5e)
...
Species: Humano (2024) [Dote de Origen: Savage Attacker + Tough]
...
Combat Role: Heavy Martial Gish / Unstoppable Tank
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Greatsword (Graze) & Maul (Topple):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: War Magic 2024 + Eldritch Strike + Action Surge + Booming Blade

🧮 Mathematical Engine 2024:

$$\text{DPR 4 Ataques + Cantrip 2024} = 4 \times (2\text{d}6 + 5 + 2) + 3\text{d}8 (\text{Booming Blade}) = \mathbf{77.5 \text{ daño/turno}}$$
