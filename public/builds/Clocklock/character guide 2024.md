# Guía de Personaje — Clocklock (Edición 2024 / 5.5e)
...
Species: Humano (2024) [Dote de Origen: Alerta + Tough]
...
Combat Role: Backline Blaster / Support / Probability Controller
...
- **Maestría de Armas (Weapon Masteries 2024):**
  - **Dagger (Nick) & Light Crossbow (Slow):** Optimiza la economía de acciones y garantiza ventaja o daño secundario plano en cada asalto.
...
## 3. The META Combo 2024: Bastion of Law + Armor of Agathys + Agonizing Blast

🧮 Mathematical Engine 2024:

$$\text{DPR Agonizing Blast} = 4 \times (1\text{d}10 + 5 (\text{CHA})) = \mathbf{42.0 \text{ daño a distancia}} + \text{Bastión de la Ley}$$
