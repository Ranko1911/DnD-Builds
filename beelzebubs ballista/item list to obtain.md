...
> **Filosofía de objetos:** Priorizar el acierto con ataques a distancia (+X en ballesta pesada), mejorar la CA de armadura media y asegurar la concentración.
...
| :--- | :---: | :---: | :--- |
| **Goggles of Night** | No | — | Prioridad Alta: Visión en la oscuridad de 60 ft. si tu especie no la tiene o para extenderla. |
| **Heavy Crossbow +1** | No | — | **Priorizar 1:** +1 a las tiradas de ataque y daño con tu arma principal. Crucial para mitigar la falta de multi-ataque físico. |
